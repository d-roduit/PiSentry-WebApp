...
export default function NotificationsTimeRangeSetting({ cameraId }) {
    ...
    const onClickSaveButton = async () => {
        ...
        await new FetchRequest(`${camerasApiEndpoint}/${cameraId}`)
            .options({
                ...
                body: JSON.stringify({
                    'notifications_start_time': newTimeRange.from,
                    'notifications_end_time': newTimeRange.to,
                }),
            })
            .success(() => {
    ...
    useEffect(() => {
        ...
        const currentTimeRange = {
            from: camera.notifications_start_time,
            to: camera.notifications_end_time,
        };
